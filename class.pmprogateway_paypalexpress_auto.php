...
define('PMPRO_PPEA_VERSION', '1.0');
if (WP_DEBUG) {
	error_log("PMPro is activated & ready to roll ");
}
	...
	static function pmpro_payment_option_fields( $values, $gateway ) {
		...
		<tr class="gateway gateway_paypal gateway_paypalexpress_auto"
			...
			<td>
				...
				<br/><p><small><? _e( "Return the user to this site to confirm payment (<strong>Note</strong>: Payment will not be collected until the user clicks the 'Confirm' button after being returned if the setting is 'Yes').", "pmpro" ); ?></small></p>
			</td>
		</tr>
		<tr class="gateway gateway_paypalexpress_auto"
		    <?php if ( $gateway != "paypalexpress_auto" && $gateway != "paypal" && $gateway != "paypalexpress" ) { ?>style="display: none;"<?php } ?>>
